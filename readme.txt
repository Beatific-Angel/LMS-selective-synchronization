...
= 2.1.0 =
* Fix - Fixed the users count issue for all users creation functionality.
* Tweak - Made plugin compatible with WordPress coding standards.

= 2.0 =
* Feature - Selective users creation from Moodle to Wordpress.
* Feature - Selective users linking from Moodle to Wordpress.
* Feature - All users creation and linking of the newly created users from Moodle to Wordpress.
* Feature - Mailing functionality for newly created users.
* Feature - Functionality to export users list faced error while creation or linking in CSV format for synchronize all users section.
* Tweak   - Updated the licensing functionality.
